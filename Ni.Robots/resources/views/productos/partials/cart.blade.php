...
<div id="cart-content"
    class="fixed top-0 pt-14 flex flex-col right-0 z-40 h-screen p-4 overflow-y-auto no-scrollbar transition-transform translate-x-full w-80 backdrop-blur-3xl  bg-white/70  dark:bg-gray-800/10"
    tabindex="-1">
    ...
    <ul role="list" id="product-list" class="overflow-y-auto no-scrollbar divide-y divide-gray-600">

    </ul>

    <div class="mt-3 space-y-3">  <div class="space-y-2">
            <div class="space-y-2">
        ...
        <div class="flex flex-col gap-2 pb-2">
            ...
            <div class="flex items-center">
                <a href="/producto/pago" type="submit"
                    class="mt-4 flex w-full items-center justify-center rounded-lg bg-blue-700  px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-blue-300  dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 sm:mt-0">Ir
                    a pagar</a>
            </div>
        </div>
