        ...
        <div class="flex-1 overflow-y-auto no-scrollbar">
            <div class="flex-1 px-3 py-5 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                <ul class="pb-2 space-y-2"> 
                    ...
                    <li>
                        <a href="/Administracion/doctor/index"
                    ...
                    <li>
                        <a href="/pacientes"
                            class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                            <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                <path d="m12.75 20.66 6.184-7.098c2.677-2.884 2.559-6.506.754-8.705-.898-1.095-2.206-1.816-3.724-1.855-1.26-.027-2.456.391-3.415 1.151a5.499 5.499 0 0 0-3.415-1.15c-1.518.04-2.826.76-3.724 1.855-1.806 2.201-1.815 5.823.754 8.706L12.75 20.66Z"/>
                            </svg>
                            <span class="ml-3" sidebar-toggle-item>Mis pacientes</span>
                        </a>
                    </li>
