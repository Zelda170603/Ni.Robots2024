<aside id="default-sidebar"
    class="fixed top-0 left-0 z-40 w-64 pt-12 h-full transition-transform -translate-x-full lg:translate-x-0"
    aria-label="Sidebar">
    <div
        class="relative flex flex-col flex-1 pt-5 pb-4  min-h-0 bg-white border-r  border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
            <ul class="pb-2 space-y-2 ">
                ...
                <li>
                    <a href="/Administracion/usuarios" type="button"
                ...
                <li>
                    <a href="{{ route('notifications.create') }}"
                        ...
                        <span class="ml-3" sidebar-toggle-item>Notificaciones</span>
                    </a>
                </li>
                ...
                <li>
                    <button type="button"
                        ...
                        <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Centros de
                            Atencion</span>
                    ...
                    <ul id="dropdown-crud" class="space-y-2 py-2 hidden ">
                        <li>
                            <a href=""
                                class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">Ver
                                centros de atencion</a>
                        </li>
                        <li>
                            <a href="{{route('CentroAtencion.create')}}"
                                class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">Anadir
                                centros de atencion</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <button type="button"
                        ...
                        <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Libros</span>
                        <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                    ...
                    <ul id="dropdown-books" class="space-y-2 py-2 hidden ">
                        <li>
                            <a href="{{route('books.index_admin')}}"
                                class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">Ver
                                ver libros</a>
                        </li>
                        <li>
                ...
                <li>
                    <button type="button"
                        class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                        aria-controls="dropdown-editoriales" data-collapse-toggle="dropdown-editoriales">
                        ...
                        <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Editoriales</span>
                        <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                    ...
                    <ul id="dropdown-editoriales" class="space-y-2 py-2 hidden ">
                        <li>
                        ...
                        <li>
                            <a href="{{route('editoriales.create')}}"
                                class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">Anadir editorial</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <button type="button"
                        class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                        aria-controls="dropdown-autores" data-collapse-toggle="dropdown-autores">
                        ...
                        <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Autores</span>
                        <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                    ...
                    <ul id="dropdown-autores" class="space-y-2 py-2 hidden ">
                        <li>
