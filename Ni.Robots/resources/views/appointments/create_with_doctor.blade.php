...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
        ...
        <div class="mb-5">
            <label for="doctor" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Médico</label>
            <select name="doctor_id" id="doctor"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                required>
                <option value="{{ $medico->id }}">  <!-- CORRECTO: user_id del doctor -->
                    {{ $medico->name }}
                </option>
            </select>
        </div>
        ...
        <div class="mb-5">
            <label for="hours" class="text-sm font-medium text-gray-900 dark:text-gray-300">Hora de atención</label>
            <div class="col">
                ...
                <div id="hoursMorning">
                    ...
                    @else
                        <mark>
                            <small class="text-warning display-5">Seleccione un medico y una fecha para ver las horas</small>
                        </mark>
                    @endif
                </div>
            </div>
        ...
        <div class="mb-5">
            ...
            <div class="flex items-center mt-3 mb-3">
                ...
                <label for="type1" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Consulta</label>
            </div>
            <div class="flex items-center mb-3">
                <input id="type2" type="radio" name="type" value="Examen"
                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                    @if (old('type') == 'Examen') checked @endif>
                <label for="type2" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Examen</label>
            </div>
            <div class="flex items-center mb-5">
                <input id="type3" type="radio" name="type" value="Operacion"
                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                    @if (old('type') == 'Operacion') checked @endif>
                <label for="type3" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Operacion</label>
            </div>
        </div>
        ...
        <div class="mb-5">
            ...
            <textarea name="description" id="description"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Descripcion breve de sus sintomas" required>{{ old('description') }}</textarea>
        </div>

        <div class="flex justify-end">
            <button type="submit"
                class="bg-green-600 text-white px-4 py-2 rounded-md shadow-sm hover:bg-green-700">Reservar cita</button>
        </div>
    </div>
</form>
        </div>
    ...
    <!-- Footer -->
    @vite('resources/js/appointments/createWithMedico.js')
@endsection
