            ...
            <div class="absolute bottom-0 left-0 right-0 px-5 pb-5 z-10"> <!-- Ajusta el fondo para mayor legibilidad -->
                ...
                <div class="flex items-center mt-2.5 mb-5">
                    ...
                    <span class="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ms-3">
                        {{ number_format($book->calificaciones_avg_puntuacion, 1) }}
                    </span>
                </div>
                <div class="flex items-center justify-between">
                    <ul class="mt-2 flex flex-col gap-4">
                        <li class="flex items-center gap-2">
                            <svg class="size-6 text-gray-200" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-width="2" d="M7 17v1a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1v-1a3 3 0 0 0-3-3h-4a3 3 0 0 0-3 3Zm8-9a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                            </svg>
                            <p class="text-md font-medium text-gray-200 ">
                                {{ $book->autor->nombre }}
                            </p>
                        </li>
                        <li class="flex items-center gap-2">
