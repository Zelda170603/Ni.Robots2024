                ...
                <ul class="pb-2 space-y-2">
                        ...
                        <ul id="dropdown-layouts" class="hidden py-2 space-y-2">
                            <li>
                                <a href="/Administracion/fabricante/productos/compras"
                                    class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Ver
                                    todas las compras</a>
                            </li>
                            <li>
                                <a href="/Administracion/fabricante/productos/compras_pendientes"
                                    class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Compras
                                    pendientes</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul id="dropdown-layouts-products" class="hidden py-2 space-y-2">
                            <li>
                                <a href="{{ route('get_productos') }}"
                                    class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Ver
                                    todos los productos</a>
                            </li>
                            <li>
                                <a href="{{ route('productos.create') }}"
                                    class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">agregar
                                    productos</a>
                            </li>
                        </ul>
                    </li>
