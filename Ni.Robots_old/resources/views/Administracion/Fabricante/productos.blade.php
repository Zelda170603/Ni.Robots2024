                ...
                <tbody>
                    @foreach ($productos as $producto)
                        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                            <td class="w-4 px-4 py-3">
                                <div class="flex items-center">
                                    <input id="checkbox-table-search-{{ $producto->id }}" type="checkbox"
                                        ...
                                        class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="checkbox-table-search-{{ $producto->id }}"
                            ...
                            <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                {{ $producto->ventasUltimoMes() }} <!-- Mostrar ventas del último mes -->
                            </td>
                            <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <div class="flex items-center">
                                    @php
                                        $averageRating = $producto->average_rating ?? 0;
                                    @endphp
                                    ...
                                    @endfor
                                    <span
                                        class="ml-1 text-gray-500 dark:text-gray-400">{{ number_format($averageRating, 1) }}</span>
                                </div>
                            </td>
                            <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                {{ $producto->totalVentas() }}
                            </td>
                            <td class="px-4 py-2">${{ $producto->totalVentas() * $producto->precio }}</td>
                            <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
