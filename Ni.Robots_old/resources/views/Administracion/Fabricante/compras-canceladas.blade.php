    ...
    <div class="col-span-4">
        <div class="mx-auto max-w-7xl lg:px-8 mb-4">
            <div class="mx-auto lg:max-w-4xl lg:px-0">
                <h1 class="text-3xl font-bold text-gray-800 dark:text-gray-200">Historial de compras canceladas</h1>
                <p class="mt-2 text-md text-gray-500 dark:text-gray-400">
                    Historial de compras canceladas por el usuario o por el proveedor
                </p>
            </div>
        </div>
        <div class="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
            @if ($comprasCanceladas->isEmpty())
                <!-- Si no hay compras pendientes, muestra este mensaje -->
                <div class="mx-auto w-full text-center text-gray-500 dark:text-gray-400">
                    <p class="text-lg">No hay compras Canceladas.</p>
                </div>
            @else
                @foreach ($comprasCanceladas as $compraProductos)
