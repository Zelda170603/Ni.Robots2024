    ...
    <div class="col-span-4">
        <div class="mx-auto max-w-7xl lg:px-8 mb-4">
            <div class="mx-auto lg:max-w-4xl lg:px-0">
                <h1 class="text-3xl font-bold text-gray-800 dark:text-gray-200">Historial de compras Completas</h1>
                <p class="mt-2 text-md text-gray-500 dark:text-gray-400">
                    Aqui puedes ver el historial de todas las compras completadas
                </p>
            </div>
        </div>
        <div class="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
            ...
            @else
                @foreach ($comprasCompletadas as $compraProductos)
