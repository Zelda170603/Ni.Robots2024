<aside  id="default-sidebar"
    class="fixed top-0 left-0 z-40 w-64 pt-12 h-screen transition-transform -translate-x-full sm:translate-x-0"
    aria-label="Sidebar" >
                ...
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        <a href="/miscitas"
                            ...
                            <span class="ml-3" sidebar-toggle-item>Mis citas</span>
                        </a>
                    </li>
                    <li>
                        <a href="/horario"
                            ...
                            <span class="ml-3" sidebar-toggle-item>Mis horarios</span>
                        </a>
                    </li>
