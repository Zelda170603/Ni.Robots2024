...
<body class="bg-white dark:bg-gray-800 mx-auto">
    ...
    <main class="flex  h-screen overflow-hidden pt-14 ">
        <!-- user list section -->
        <section class=" bg-inherit px-4 pt-4 sm:w-80 w-full border-r-2 sm:border-r border-r-slate-200 dark:border-r-slate-500 flex flex-col h-screen">
            <div class="text-slate-600 dark:text-white max-w-sm  pb-6">
                <h1 class="text-3xl font-bold">Mensajes</h1>
            </div>
            <div class="flex items-center sm:max-w-sm pb-6">
            ...
            <!-- lista de chats -->
            <div class="pt-4 flex-1 overflow-y-auto no-scrollbar">
                ...
                <div class="flex items-center space-x-4 pb-4 last-of-type:pb-0">
                    <div class="flex-shrink-0">
                        <img class="w-12 h-12 object-cover rounded-full"
                            src="{{ Storage::url('images/fabricantes/1718226350.jpg') }}" alt="Neil image">
                    </div>
        ...
        <section class="bg-inherit v flex-1 flex flex-col overflow-y-auto">

            <div class="flex items-center px-4 py-2 border-b bg-gray-700 border-b-slate-200 dark:border-b-slate-500 gap-2">
            ...
            <div class="flex flex-col gap-4 p-4 mt-4 overflow-y-auto no-scrollbar">
