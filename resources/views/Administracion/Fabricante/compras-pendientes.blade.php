    ...
    <div class="col-span-4">
        <div class="mx-auto max-w-7xl lg:px-8 mb-4">
            <div class="mx-auto lg:max-w-4xl lg:px-0">
                <h1 class="text-3xl font-bold text-gray-800 dark:text-gray-200">Historial de compras pendientes</h1>
                <p class="mt-2 text-md text-gray-500 dark:text-gray-400">
                    Aqui puedes gestionar el estado de las ordenes pendientes
                </p>
            </div>
        </div>
                    ...
                    @foreach ($compraProductos as $orden)
                        <div
                            ...
                            <div class=" flex items-center justify-between">
                                ...
                                <div>
                                    <select id="countries"
                                        class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg dark:bg-gray-800 focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <option selected>Selecciona el estado de la compra</option>
