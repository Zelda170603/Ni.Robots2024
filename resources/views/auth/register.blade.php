                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="departamento" name="departamento_id" class="form-control @error('departamento_id') is-invalid @enderror" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="municipio" name="municipio_id" class="form-control @error('municipio_id') is-invalid @enderror" required>
