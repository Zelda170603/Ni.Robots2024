    ...
    <div class="overflow-hidden py-8">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div
                    ...
                    <div class="lg:max-w-lg">
                        ...
                        <dl class="mt-10 max-w-xl space-y-8 text-base leading-7 lg:max-w-none">
                            <div class="relative pl-9">
                                ...
                                <dd class="inline text-gray-900 dark:text-gray-300">Realiza tu pedido de herramientas y
                                    materiales de ferretería de manera
                            ...
                            <div class="relative pl-9">
                                ...
                                <dd class="inline text-gray-900 dark:text-gray-300">Todos nuestros productos están
                                    respaldados por certificados de calidad
                            ...
                            <div class="relative pl-9">
                                ...
                                <dd class="inline text-gray-900 dark:text-gray-300">Ofrecemos soporte técnico especializado
                                    para ayudarte
                ...
                <img src="/images/index/ferreteria.jpg" alt="Product screenshot"
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a class="group relative flex flex-col w-full min-h-60 bg-[url('https://images.unsplash.com/photo-1634017839464-5c339ebe3cb4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=560&q=80')] bg-center bg-cover rounded-xl hover:shadow-lg focus:outline-none focus:shadow-lg transition"
                ...
                <div class="flex-auto p-4 md:p-6">
                    <h3 class="text-xl text-white/90 group-hover:text-white"><span class="font-bold">Preline</span> Press
                        publishes books about economic and technological
                        advancement.</h3>
                </div>
