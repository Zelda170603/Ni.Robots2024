<aside class="fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform -translate-x-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700"
    ...
    <div class="overflow-y-auto no-scrollbar py-5 px-3 h-full bg-white dark:bg-gray-800">
        <ul class="space-y-2">
            <li>
                <a href=""
                    ...
                    <span class="ml-3">Pagina principal</span>
                </a>
            </li>
            <li>
                <a href="/books"
                    ...
                    <span class="ml-3">seccion educativa</span>
                </a>
            </li>
            <li>
                <a href="/productos"
            ...
            @if (Auth::check() && Auth::user()->role && Auth::user()->role->role_type === 'paciente')
                <li>
                    <button type="button"
                        class="flex items-center p-2 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                        aria-controls="dropdown-citas" data-collapse-toggle="dropdown-citas">
                        ...
                        <span class="flex-1 ml-3 text-left whitespace-nowrap">Citas Medicas</span>
                    ...
                    <ul id="dropdown-citas" class="hidden py-2 space-y-2">
                        <li>
                            <a href="/miscitas"
                                class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Ver mis citas</a>
                        </li>
                        <li>
                            <a href="/reservarcitas/create"
                                class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Crear cita</a>
                        </li>
                    </ul>
                </li>
            @endif
            <li>
                <button type="button"
                    ...
                    <span class="flex-1 ml-3 text-left whitespace-nowrap">Atencion medica</span>
                    <svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
                            d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                ...
                <ul id="dropdown-sales" class="hidden py-2 space-y-2">
                    <li>
                        <a href="{{route("atencion_medica")}}"
                            class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">ir a pagina principal</a>
                    </li>
                    <li>
                        <a href=""
                            class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Ver centros de atencion</a>
                    </li>
                    <li>
                        <a href="{{route("view_doctores_user")}}"
                            class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">ver medicos</a>
                    </li>
                </ul>
            </li>
            <li>
