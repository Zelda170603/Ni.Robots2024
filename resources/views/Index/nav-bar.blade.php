    ...
    <div class="max-w-[85rem] w-full mx-auto  md:gap-3 py-2 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-5 justify-between items-center ">
            ...
            @auth
                            ...
                            <li>
                                <a href="/compras"
                                    ...
                                    <span class="flex items-center">
                                        <svg class="mr-2 w-5 h-5 text-blue-600 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                @else
                    <!-- Collapse Button -->
                    <div class="lg:hidden relative flex justify-end col-span-3">
                        <button type="button"
                    ...
                    <div id="hs-header-base"
                        class="hs-collapse hidden md:col-span-3 col-span-4 overflow-hidden transition-all duration-300 basis-full grow lg:block "
