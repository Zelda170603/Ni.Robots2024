...
<body>
    <div class="flex  flex-col bg-gradient-to-r from-yellow-200 via-green-200 to-green-300">
        <div class="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div class="sm:mx-auto sm:w-full sm:max-w-md">
                <img class="mx-auto h-12 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&amp;shade=600" alt="Your Company">
                <h2 class="mt-10 text-center text-lg font-bold leading-9 tracking-tight text-opacity-100 text-blue-950">Sign in
                    to your account</h2>
            </div>
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-lg">
                <div class="backdrop-blur-sm bg-white/20 px-6 py-12 shadow-2xl rounded-lg sm:px-12">
                    ...
                    <div>
                        ...
                        <div class="mt-6 grid grid-cols-2 gap-4">
                            <a href="#" class="flex w-full items-center justify-center gap-3 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring ring-inset ring-gray-100 hover:bg-slate-100 focus-visible:ring-transparent">
                            ...
                            <a href="#" class="flex w-full items-center justify-center gap-3 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring ring-inset ring-gray-100 hover:bg-slate-100 focus-visible:ring-transparent">
                                <svg  class="w-5 h-5 fill-slate-950" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
